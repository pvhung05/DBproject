...
const InvoiceTable = () => {
  ...
  useEffect(() => {
    // Fetch all invoices
    fetch("https://backend-fu5o.onrender.com/api/invoices")
      .then((response) => {
        if (!response.ok) {
    ...
    fetch("https://backend-fu5o.onrender.com/api/employees")
    ...
    fetch("https://backend-fu5o.onrender.com/api/products")
      .then((response) => response.json())
      ...
      {showModal && (
        <div className="modal">
          <div className="modal-content">
            ...
            <button onClick={addProductField} style={{ width: "300px" }}>
              Thêm Sản Phẩm
            </button>
            <br />
